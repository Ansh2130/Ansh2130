...
#=========================================perscription data button fxn==============================
    ...
    def exit():
        ...
        if confirm>0:
            ...
            return               
    #Heading
    Label(win,text='Pharmacy Management System',font='impack 31 bold',bg='blue',fg='white').pack(fill=X)
    #Frame1
    ...
    Label(lf1, text='Product Name', bg='pink').place(x=370, y=210)
    Label(lf1, text='Quantity', bg='pink').place(x=735, y=10)
    Label(lf1, text='Total Price', bg='pink').place(x=735, y=40)
    Label(lf1, text='Sale Date', bg='pink').place(x=735, y=70)
    ...
    #Clear button
    c_btn=Button(win,text='Clear',font='ariel 15 bold',bg='brown',fg='white',bd=6,cursor='hand2',command=clear)
    ...
    e_btn.place(x=1140,y=700,width=200)
     #Button for Sales
    sales_btn = Button(win, text='Record Sales', font='ariel 15 bold', bg='orange', fg='white', bd=6, cursor='hand2', command=sales)
