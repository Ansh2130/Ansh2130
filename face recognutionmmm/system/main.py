...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'as7379078@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message='Please contact Abhishek')
        window.destroy()
...
window.configure(background='#10182f')

frame1 = tk.Frame(window, bg="#455799") 
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#455799") 
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System" ,fg="white",bg="#6499a7" ,width=56 ,height=1,font=('Georgia', 26, ' bold '))
message3.place(x=0, y=5)

frame3 = tk.Frame(window, bg="white")
frame3.place(relx=0.66, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="#c4c6ce")
frame4.place(relx=0.18, rely=0.09, relwidth=0.26, relheight=0.07)

datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"", fg="yellow",bg="#455799" ,width=55 ,height=1,font=('georgia', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="yellow",bg="#455799" ,width=55 ,height=1,font=('times', 22 , ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                     For New Registrations             ", fg="#10182f",bg="#b295c9" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)
head2.place(x=12, y=3)

head1 = tk.Label(frame1, text="                    For Already Registered               ", fg="#10182f",bg="#b295c9" ,font=('comic', 17, ' bold ') )
head1.place(x=13,y=3)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#d6e6db" ,font=('comic', 17, '  ') )
lbl.place(x=80, y=52)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 14, ' bold '))
txt.place(x=32, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#d6e6db" ,font=('comic', 17, '  '))
lbl2.place(x=80, y=136)
...
message5=tk.Label(window, text="             Made by Ansh                 ", fg="red",bg="white", width=30, height=1, font=('times', 9, '  '))

message5.place(x=550, y=698)
